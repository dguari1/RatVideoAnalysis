...
class FramesAnalysis(QObject):
    ...
    def __init__(self,folder_name,ListofFiles, FaceCenter, RightROI, LeftROI, threshold, angles, parallel, resultsInfo):
...
class AnalysisWindow(QDialog):
    ...
    def Done(self):
        ...
        self.FrameAna = FramesAnalysis(self._folder, self._selectedList, self._FaceCenter, self._RightROI, self._LeftROI, self._threshold, self._angles, self._Parallel, self._ResultsInfo)
